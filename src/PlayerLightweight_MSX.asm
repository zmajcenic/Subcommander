...
;       This code is specific to the MSX hardware and a PSG running at 1773400 Hz.
...
PLY_LW_STOP_SOUNDS equ 1                               ;1 to have the "stop sounds" code. Set it to 0 if you never plan on stopping your music.
        ...
        IFDEF PLY_CFG_SoftOnly_SoftwarePitch
                PLY_LW_PitchInInstrument EQU 1
        ENDIF
        IFDEF PLY_CFG_SoftToHard_SoftwarePitch
		IFNDEF PLY_LW_PitchInInstrument
			PLY_LW_PitchInInstrument EQU 1
		ENDIF
                IFNDEF PLY_LW_PitchInHardwareInstrument
                	PLY_LW_PitchInHardwareInstrument EQU 1
		ENDIF
        ENDIF
        ...
        IFDEF PLY_CFG_SoftOnly_SoftwareArpeggio
                PLY_LW_ArpeggioInInstrument EQU 1
        ENDIF
        IFDEF PLY_CFG_SoftToHard_SoftwareArpeggio
		IFNDEF PLY_LW_ArpeggioInInstrument
                	PLY_LW_ArpeggioInInstrument EQU 1
		ENDIF
		IFNDEF PLY_LW_ArpeggioInHardwareInstrument
                	PLY_LW_ArpeggioInHardwareInstrument EQU 1
		ENDIF
        ENDIF
        ...
        IFDEF PLY_CFG_NoSoftNoHard_Noise
                PLY_LW_USE_Noise EQU 1
        ENDIF
        IFDEF PLY_CFG_SoftOnly_Noise
		IFNDEF PLY_LW_USE_Noise
                	PLY_LW_USE_Noise EQU 1
		ENDIF
        ENDIF
        ...
        IFDEF PLY_CFG_UseEffect_SetVolume
                PLY_LW_USE_Volume_And_ArpeggioTable_Effects EQU 1
		IFNDEF PLY_CFG_UseEffect_ArpeggioTable
                	PLY_CFG_UseEffect_ArpeggioTable EQU 1
		ENDIF
        ENDIF
        IFDEF PLY_CFG_UseEffect_ArpeggioTable
		IFNDEF PLY_LW_USE_Volume_And_ArpeggioTable_Effects
                	PLY_LW_USE_Volume_And_ArpeggioTable_Effects EQU 1
		ENDIF
		IFNDEF PLY_CFG_UseEffect_SetVolume
                	PLY_CFG_UseEffect_SetVolume EQU 1
        ...
        IFDEF PLY_CFG_UseEffect_Reset
                PLY_LW_USE_Reset_And_ArpeggioTable_Effects EQU 1
		IFNDEF PLY_CFG_UseEffect_ArpeggioTable
                	PLY_CFG_UseEffect_ArpeggioTable EQU 1
		ENDIF
        ENDIF
        IFDEF PLY_CFG_UseEffect_ArpeggioTable
		IFNDEF PLY_LW_USE_Reset_And_ArpeggioTable_Effects
                	PLY_LW_USE_Reset_And_ArpeggioTable_Effects EQU 1
		ENDIF
		IFNDEF PLY_CFG_UseEffect_Reset
                	PLY_CFG_UseEffect_Reset EQU 1
		ENDIF
        ENDIF
	...
	;	assert PLY_LW_Start == $		;Makes sure no extra byte were inserted before the hooks.
		...
		read "PlayerLightWeight_SoundEffects.asm"
        ENDIF
...
PLY_LW_PSS_Shared_ReadEnvBitPitchArp_SoftPeriod_HardVol_HardEnv:
        ...
        xor a                   ;Default arpeggio.
                        IFDEF PLY_LW_ArpeggioInHardwareInstrument
